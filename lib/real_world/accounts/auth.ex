defmodule RealWorld.Accounts.Auth do
  ...
  def find_user_and_check_password(%{email: email, password: password} = args) do
    find_user_and_check_password(%{"user" => %{"email" => email, "password" => password}})
  end
